# 4.Laboratorijska vježba(Password-hashing [iterative hashing, salt, memory-hard functions])

Zaporke su najkorišreniji i najzastupljeniji način autentikacije korisnkika(jednostavno i jeftino).U okviru ove vježbe proučit ćemo načine:

**Iterative hashing** - kompromis između brzine i sigurnosti.Svaka lozinka se hashira te ako želimo možemo taj isti hash hashirati koliko god puta htjeli.

**Salt(sol)** - dodaje se prije hashiranja,svaki 'salt' je jedinstven.

**Memory-hard functions** - namjerno se usporava rad hashiranja da napad bude ekonomički beskoristan.

**Kod za računanje vremena za stvaranje hash vrijednosti sa nekoliko hashfunkcija**
...
različite hash funkcije su dale različita vremena stoga koristimo određene funkcije za oređene sigurnosne barijere.

![Untitled](4%20Laboratorijska%20vjez%CC%8Cba(Password-hashing%20%5Biterati%20be54d8be457a4be597f0bff066cc9229/Untitled.png)